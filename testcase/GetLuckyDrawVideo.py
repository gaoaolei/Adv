...
url = "https://api-ks.wtzw.com/api/v1/lucky-draw/get-lucky-draw-video?apiVersion=20190309143259-1.9&t=1612712466369"


@paramunittest.parametrized(*xls)
class TestLuckyDrawVideo(unittest.TestCase):
    ...
    def test_null(self):
        ...
        self.assertNotEqual(self.api_data['data']['lucky_draw_video_url'], '')
