...
url = "https://api-ks.wtzw.com/api/v1/sign-in/get-sign-video?apiVersion=20190309143259-1.9&t=1612712372230"


@paramunittest.parametrized(*xls)
class TestSignVideo(unittest.TestCase):
    ...
    def test_null(self):
        ...
        self.assertNotEqual(self.api_data['data']['bare_sign_video_url'], '')
        self.assertNotEqual(self.api_data['data']['free_adv_video'], '')
        self.assertNotEqual(self.api_data['data']['inspire_video_url'], '')
