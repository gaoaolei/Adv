...
area_config_id = 26
url = "https://api-ks.wtzw.com/api/v1/float-adv-android?gender=2&sign=630fb29dde5d9084cc3c11647bc093d4"


@paramunittest.parametrized(*xls)
class TestFloatAdvAndroid(unittest.TestCase):
    ...
    def test_null(self):
        self.assertNotEqual(self.api_data['data']['float']['my_center'], {})
